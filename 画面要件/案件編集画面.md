...
![案件管理画面WF](案件編集画面WF_20240901.png)
...
案件編集|POST|/v1/projects/{id}|案件情報をprojects,estimations,assignment_member_monthly_estimations,assignment_members,outsourcesに情報が編集される|
